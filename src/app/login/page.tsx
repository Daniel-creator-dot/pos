                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="input pl-10 pr-10 h-11 border-gray-200 rounded-xl transition-all duration-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/10 placeholder:text-gray-400 text-gray-900 bg-white"
                      placeholder="••••••••"
                      required
